...
<html>
    ...
    <body>
        <div class="container">
                    ...
                    <c:forEach items="${listQuestion}" var="lq">
                        <div class="Quiz-name">
                            ...
                            <div class="Icon" style="width: 20%;text-align: right">
                                <a href="question/update?updateId=${lq.questionId}"  class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <a href="question/delete?deleteId=${lq.questionId}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                            </div>
                        </div>
                        <c:if test="${lq.media != null}">
                            <img style="height: 150px;width: 260px;margin-bottom: 10px" src="${lq.media}" alt="" />
                        </c:if>
            ...
            <a href="quiz"><button type="button" class="btn btn-primary">Back</button>
        </div>
    </body>
</html>
<style>

 ...
 * @author nguye
 */
public class FilterQuizByLevelController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Quiz> list = dao.getAllQuizByLevel(quizLevelId);
        ...
        request.setAttribute("tag1", quizLevelId);
